...
//
    function ContentBox_Set(slider_box_class, content_show, color, S_width, S_height, pointBox_height, src) {
        if (content_show) {
            $('<div/>', {
...
//adjust about
    ...
    function Data_Adjust(slider_box_class, S_width, S_height, num, src, img_link, point_l_r_margin, content_show, color) {
        ...
        ContentBox_Set(slider_box_class, content_show, color, S_width, S_height, pointBox_height, src);
    }
//show about
