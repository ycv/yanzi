...
var Zepto = function () {
	...
	X.init = function (a, c) {
		...
		if (!a)
			return X.Z();
		if ("string" == typeof a)
			if (a = a.trim(), "<" == a[0] && J.test(a))
				d = X.fragment(a, RegExp.$1, c), a = null;
			else {
				if (c !== w)
					return y(c).find(a);
				d = X.qsa(F, a)
			...
			if (g(a))
				...
				d = X.fragment(a.trim(), RegExp.$1, c), a = null;
			else {
				if (c !== w)
					return y(c).find(a);
				d = X.qsa(F, a)
	...
	y.fn = {
		...
		closest : function (a, b) {
			var c = this[0],
			e = !1;
			for ("object" == typeof a && (e = y(a)); c && !(e ? e.indexOf(c) >= 0 : X.matches(c, a)); )
		...
		css : function (b, c) {
			if (arguments.length < 2) {
				...
				if (!d)
					return;
				if ("string" == typeof b)
					return d.style[A(b)] || e.getPropertyValue(b);
				if (g(b)) {
					var f = {};
			...
			var h = "";
			if ("string" == a(b))
				c || 0 === c ? h = k(b) + ":" + m(b, c) : this.each(function () {
						this.style.removeProperty(k(b))
					});
			else
				for (x in b)
					b[x] || 0 === b[x] ? h += k(x) + ":" + m(x, b[x]) + ";" : this.each(function () {
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (a) {
	...
	function c(a, c, f, g) {
		if (c = d(c), c.ns)
			var h = e(c.ns);
		return (p[b(a)] || []).filter(function (a) {
	...
	function g(c, e, g, h, j, l, m) {
		var n = b(c),
		o = p[n] || (p[n] = []);
		e.split(/\s/).forEach(function (b) {
			if ("ready" == b)
				return a(document).ready(g);
			var e = d(b);
			e.fn = g,
			e.sel = j,
			e.del = l;
			...
			e.proxy = function (a) {
				if (a = i(a), !a.isImmediatePropagationStopped()) {
					a.data = h;
					var b = n.apply(c, a._args == k ? [a] : [a].concat(a._args));
			...
			e.i = o.length,
			o.push(e),
			"addEventListener" in c && c.addEventListener(e.e, e.proxy, f(e, m))
		})
	}
	function h(a, d, e, g, h) {
		var i = b(a);
	...
	function i(b, c) {
		return (c || !b.isDefaultPrevented) && (c || (c = b), a.each(u, function (a, d) {
				var e = c[a];
				b[a] = function () {
					return this[d] = r,
				...
				b[d] = s
			}), (c.defaultPrevented !== k ? c.defaultPrevented : "returnValue" in c ? c.returnValue === !1 : c.getPreventDefault && c.getPreventDefault()) && (b.isDefaultPrevented = r)),
		b
	}
	function j(a) {
		var b,
	...
	a.fn.on = function (b, c, d, e, f) {
		...
		l,
		p = this;
		return b && !o(b) ? (a.each(b, function (a, b) {
				p.on(a, c, d, b, f)
			}), p) : (o(c) || n(e) || e === !1 || (e = d, d = c, c = k), (n(d) || d === !1) && (e = d, d = k), e === !1 && (e = s), p.each(function (k, n) {
				f && (i = function (a) {
					return h(n, a.type, e),
				...
				c && (l = function (b) {
					var d,
					f = a(b.target).closest(c, n).get(0);
					return f && f !== n ? (d = a.extend(j(b), {
								currentTarget : f,
								liveFired : n
							}), (i || e).apply(f, [d].concat(m.call(arguments, 1)))) : void 0
				}),
				g(n, b, e, d, c, l || i)
			}))
	},
	a.fn.off = function (b, c, d) {
		...
		return b && !o(b) ? (a.each(b, function (a, b) {
				e.off(a, c, b)
			}), e) : (o(c) || n(d) || d === !1 || (d = c, c = k), d === !1 && (d = s), e.each(function () {
				h(this, b, d, c)
			}))
	},
	a.fn.trigger = function (b, c) {
		return b = o(b) || a.isPlainObject(b) ? a.Event(b) : i(b),
		b._args = c,
		this.each(function () {
...
(Zepto), function (a) {
	...
	a(document).ready(function () {
		...
		a(document).on("MSGestureEnd", function (a) {
...
(Zepto), function (a) {
	function b(a, b) {
		...
		if (c) {
			if (-1 === a.indexOf("../"))
				return c.replace(/\/[^\/]+$/, "/") + a.replace("./", "");
			for (var f = a.split("../"), g = c.replace(/\/[^\/]+$/, "").split("/"); f.length > 1; )
				f.shift(), g.pop();
...
(window), function (a) {
	...
	var d = /waptest|daily|taobao\.net|localhost/.test(location.host) ? "http://g.assets.daily.taobao.net/" : "http://g.tbcdn.cn/",
...
(Zepto), function () {
	...
	function e(a, b) {
		...
		d = b.criteria;
		if (c !== d) {
			if (c > d || "undefined" == typeof c)
				return 1;
			if (d > c || "undefined" == typeof d)
				return -1
		}
	...
	function m(c) {
		...
		function S(a, b, c, d, e) {
			...
			if (b) {
				...
				f = m ? l(a) : Zd({}, a);
			return m && (Ad.call(a, "index") && (f.index = a.index), Ad.call(a, "input") && (f.input = a.input)),
			b ? (d.push(a), e.push(f), (m ? Yd : ae)(a, function (a, g) {
					f[g] = S(a, b, c, d, e)
				}), n && (j(d), j(e)), f) : f
		}
		function U(a) {
		...
		function X(a) {
			function b() {
				...
				if ((f || k) && (o || (o = l(arguments)), f && Cd.apply(o, f), k && o.length < h))
					return d |= 16, X([c, m ? d : -4 & d, o, null, g, h]);
		...
		function $(a, b, c, d, e, f) {
			...
			var n = l == H;
			if (!n) {
				var o = Ad.call(a, "__wrapped__"),
				p = Ad.call(b, "__wrapped__");
				if (o || p)
					return $(o ? a.__wrapped__ : a, p ? b.__wrapped__ : b, c, d, e, f);
				if (l != M)
					return !1;
				var q = a.constructor,
				r = b.constructor;
				if (q != r && !(zb(q) && q instanceof q && zb(r) && r instanceof r) && "constructor" in a && "constructor" in b)
					return !1
			}
			var s = !e;
			e || (e = h()),
			...
			if (g = !0, e.push(a), f.push(b), n) {
				if (t = a.length, u = b.length, g = u == a.length, !g && !d)
					return g;
				for (; u--; ) {
					var v = t,
					w = b[u];
					if (d)
						for (; v-- && !(g = $(a[v], w, c, d, e, f)); );
					else if (!(g = $(a[u], w, c, d, e, f)))
						break
				}
				return g
			}
			return _d(b, function (b, h, i) {
		...
		function cb(a) {
			return function (b, c, d) {
				var e = {};
				if (c = o.createCallback(c, d, 3), Rd(b))
		...
		function gb(a) {
			...
			return a && ud.call(a) == M && (b = a.constructor, !zb(b) || b instanceof b) ? (_d(a, function (a, b) {
					c = b
				}), "undefined" == typeof c || Ad.call(a, c)) : !1
		}
		function hb(a) {
			return Vd[a]
		}
		...
		function sb(a) {
			for (var b = -1, c = Td(a), d = c.length, e = {}; ++b < d; ) {
				var f = c[b];
				e[a[f]] = f
			}
			return e
		...
		function Ib(a, b, c) {
			...
			if ("function" != typeof b) {
				...
				b = o.createCallback(b, c, 3), _d(a, function (a, c, e) {
					b(a, c, e) || (d[c] = a)
				});
			return d
		}
		function Jb(a) {
			for (var b = -1, c = Td(a), d = c.length, e = fd(d); ++b < d; ) {
				var f = c[b];
				e[b] = [f, a[f]]
			}
			return e
		...
		function Kb(a, b, c) {
			var d = {};
			if ("function" != typeof b)
				for (var e = -1, f = Z(arguments, !0, !1, 1), g = Ab(a) ? f.length : 0; ++e < g; ) {
					var h = f[e];
					h in a && (d[h] = a[h])
				}
			else
		...
		function Nb(a) {
			for (var b = arguments, c = -1, d = Z(b, !0, !1, 1), e = b[2] && b[2][b[1]] === a ? 1 : d.length, f = fd(e); ++c < e; )
				f[c] = a[d[c]];
			return f
		}
		function Ob(a, b, c) {
			...
			f = a ? a.length : 0,
			g = !1;
			return c = (0 > c ? Ld(0, f + c) : c) || 0,
			Rd(a) ? g = e(a, b, c) > -1 : "number" == typeof f ? g = (Fb(a) ? a.indexOf(b, c) : e(a, b, c)) > -1 : Yd(a, function (a) {
		...
		function Ub(a, b, c) {
			var d = a,
			e = a ? a.length : 0;
			if (b = b && "undefined" == typeof c ? b : W(b, c, 3), Rd(a))
				for (; e-- && b(a[e], e, a) !== !1; );
			else {
				if ("number" != typeof e) {
					var f = Td(a);
		...
		function Xb(a, b, c) {
			var e = -1 / 0,
			f = e;
			if ("function" != typeof b && c && c[b] === a && (b = null), null == b && Rd(a))
				for (var g = -1, h = a.length; ++g < h; ) {
					var i = a[g];
					i > f && (f = i)
				}
			else
				b = null == b && Fb(a) ? d : o.createCallback(b, c, 3), Yd(a, function (a, c, d) {
					var g = b(a, c, d);
					g > e && (e = g, f = a)
				});
			return f
		...
		function ac(a, b, c) {
			if (a && "number" != typeof a.length && (a = Mb(a)), null == b || c)
				return a ? a[ab(0, a.length - 1)] : n;
			var d = bc(a);
			return d.length = Md(Ld(0, b), d.length),
			d
		}
		function bc(a) {
			var b = -1,
		...
		function nc(a, b, c) {
			...
			if ("number" != typeof b && null != b) {
				...
				d = null == b || c ? 1 : b || d;
			return l(a, 0, Md(Ld(0, e - d), e))
		}
		function oc(c) {
			for (var d = arguments, e = d.length, g = -1, i = h(), l = -1, m = fb(), n = c ? c.length : 0, o = [], p = h(); ++g < e; ) {
				var q = d[g];
		...
		function qc(a, b, c) {
			var d = a ? a.length : 0;
			for ("number" == typeof c && (d = (0 > c ? Ld(0, d + c) : Md(c, d - 1)) + 1); d--; )
				if (a[d] === b)
					return d;
			return -1
		}
		...
		function sc(a, b, c) {
			...
			null == b && (b = a, a = 0);
			for (var d = -1, e = Ld(0, wd((b - a) / (c || 1))), f = fd(e); ++d < e; )
				f[d] = a, a += c;
			return f
		}
		function tc(a, b, c) {
		...
		function vc(a, b, c, d) {
			var e = 0,
			f = a ? a.length : e;
			for (c = c ? o.createCallback(c, d, 1) : Sc, b = c(b); f > e; ) {
				var g = e + f >>> 1;
				c(a[g]) < b ? e = g + 1 : f = g
			}
			return e
		...
		function zc() {
			for (var a = arguments.length > 1 ? arguments : arguments[0], b = -1, c = a ? Xb(fe(a, "length")) : 0, d = fd(0 > c ? 0 : c); ++b < c; )
				d[b] = fe(a, b);
			return d
		}
		function Ac(a, b) {
		...
		function Dc(a) {
			for (var b = arguments.length > 1 ? Z(arguments, !0, !1, 1) : qb(a), c = -1, d = b.length; ++c < d; ) {
				var e = b[c];
		...
		function Gc(a, b, c) {
			...
			return 1 != e.length || g !== g || Ab(g) ? function (b) {
				for (var c = e.length, d = !1; c-- && (d = $(b[e[c]], a[e[c]], null, !0)); );
				return d
			}
			 : function (a) {
				var b = a[f];
		...
		function Ic(a, b, c) {
			...
			if (b = Ld(0, b) || 0, c === !0) {
				...
				Ab(c) && (o = c.leading, l = "maxWait" in c && (Ld(b, c.maxWait) || 0), m = "trailing" in c ? c.trailing : m);
			var p = function () {
				var c = b - (Bd() - g);
				if (0 >= c) {
					e && xd(e);
					var l = j;
					e = i = j = n,
					l && (k = Bd(), f = a.apply(h, d), i || e || (d = h = null))
				} else
					i = Ed(p, c)
			},
			q = function () {
				i && xd(i),
				e = i = j = n,
				(m || l !== b) && (k = Bd(), f = a.apply(h, d), i || e || (d = h = null))
			};
			return function () {
				if (d = arguments, g = Bd(), h = this, j = m && (i || !o), l === !1)
					var c = o && !i;
				else {
					e || o || (k = g);
					var n = l - (g - k),
				...
				return r && i ? i = xd(i) : i || b === l || (i = Ed(p, b)),
				c && (r = !0, f = a.apply(h, d)),
				!r || i || e || (d = h = null),
				f
			}
		...
		function Pc(a, b, c) {
			...
			if (!zb(a))
				throw new pd;
			return c === !1 ? d = !1 : Ab(c) && (d = "leading" in c ? c.leading : d, e = "trailing" in c ? c.trailing : e),
			Q.leading = d,
			Q.maxWait = b,
			Q.trailing = e,
			Ic(a, b, Q)
		...
		function Yc(a, b, c) {
			...
			c = $d({}, c, d);
			var e,
			f = $d({}, c.imports, d.imports),
			h = Td(f),
			i = Mb(f),
			j = 0,
			k = c.interpolate || C,
			l = "__p += '",
			m = nd((c.escape || C).source + "|" + k.source + "|" + (k === A ? y : C).source + "|" + (c.evaluate || C).source + "|$", "g");
		...
		td = c._,
		ud = sd.toString,
		vd = nd("^" + od(ud).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
		wd = kd.ceil,
		xd = c.clearTimeout,
		yd = kd.floor,
		zd = vd.test(zd = md.getPrototypeOf) && zd,
		Ad = sd.hasOwnProperty,
		Bd = vd.test(Bd = hd.now) && Bd || function () {
			return +new hd
		},
		Cd = qd.push,
		Dd = sd.propertyIsEnumerable,
		Ed = c.setTimeout,
		Fd = qd.splice,
		Gd = vd.test(Gd = md.create) && Gd,
		Hd = vd.test(Hd = fd.isArray) && Hd,
		Id = c.isFinite,
		Jd = c.isNaN,
		Kd = vd.test(Kd = md.keys) && Kd,
		Ld = kd.max,
		Md = kd.min,
		Nd = c.parseInt,
		Od = kd.random,
		...
		var Qd = o.support = {};
		Qd.enumErrorProps = Dd.call(rd, "message") || Dd.call(rd, "name"),
		Qd.enumPrototypes = !0,
		Qd.nonEnumArgs = !0,
		o.templateSettings = {
			escape : /<%-([\s\S]+?)%>/g,
		...
		Sd = function (a) {
			...
			if (b = -1, e && ib(c))
				...
				for (b in c)
					f && "prototype" == b || !Ad.call(c, b) || d.push(b)
			}
			return d
		},
		Td = Kd ? function (a) {
		...
		Yd = function (a, b, c) {
			...
			if (d = -1, "number" == typeof g) {
				...
				for (d in e)
					if ((!h || "prototype" != d) && Ad.call(e, d) && b(e[d], d, a) === !1)
						return f
			}
			return f
		},
			...
			for (; ++h < i; )
				if (e = g[h], e && R[typeof e]) {
					...
					if (d = -1, k && ib(e))
						...
						for (d in e)
							l && "prototype" == d || !Ad.call(e, d) || (f[d] = j ? j(f[d], e[d]) : e[d])
					}
				}
			return f
		},
			...
			for (var g = arguments, h = 0, i = "number" == typeof c ? 2 : g.length; ++h < i; )
				if (e = g[h], e && R[typeof e]) {
					...
					if (d = -1, j && ib(e))
						...
						for (d in e)
							k && "prototype" == d || !Ad.call(e, d) || "undefined" == typeof f[d] && (f[d] = e[d])
					}
				}
			return f
		},
		...
		var be = zd ? function (a) {
			if (!a || ud.call(a) != M)
				return !1;
			var b = a.valueOf,
			c = "function" == typeof b && (c = zd(b)) && zd(c);
			return c ? a == c || zd(a) == c : gb(a)
		}
		 : gb,
		ce = cb(function (a, b, c) {
		...
		o.VERSION = "2.3.0",
		o.prototype.chain = cd,
		o.prototype.toString = dd,
		o.prototype.value = ed,
		o.prototype.valueOf = ed,
		Yd(["join", "pop", "shift"], function (a) {
			var b = qd[a];
...
.call(this), function (a, b) {
	...
	l.prototype = {
		...
		init : function (a) {
			...
			var e = b.from || "h5",
			k = b.crossplat || !1;
			if (this.bannerUrl = "ios" != this.platform || k ? b.url || "http://m.taobao.com/channel/act/sale/tbdl1.html" : b.appstoreUrl || (this.isIpad ? "https://itunes.apple.com/app/id438865278" : "http://itunes.apple.com/cn/app/id387682726?mt=8"), b.href) {
				var l = b.href,
				m = c(),
				n = i.getElementById("buried"),
				o = m.ttid || n && n.value,
				p = m.refid,
				q = m.ali_trackid,
				r = m.pid,
				...
				if (o && (w.ttid = o), p && (w.refid = p), q && (w.ali_trackid = q), r && (w.pid = r), s && (w.actparam = s), t && (w.actname = t), u && (w.ad_id = u), v && (w.source_type = v), w.url = encodeURIComponent(location.href.split(/[?#]/)[0]), j && (w.h5_uid = j), w.ap_uri = "", b.point)
					for (var x in b.point)
						w[x] = b.point[x];
				if (w = encodeURIComponent(JSON.stringify(w)), l = l.split("#"), -1 == l[0].indexOf("?") ? l[0] += "?" : l[0].indexOf("?") != l.length - 1 && (l[0] += "&"), l[0] += "point=" + w, l = l.join("#"), l = -1 != l.indexOf("://") ? l : "taobao://" + l, this.isChrome) {
					var y = l.split("://"),
					z = y[0],
					A = y[1],
					B = b.bag || "com.taobao.taobao";
					l = "intent://" + A + "#Intent;scheme=" + z + ";package=" + B + ";end"
				}
				this.paramUrl = l
			}
			return !0
...
(window, window.lib || (window.lib = {})), function () {
	...
	templates["tpl-listview-item"] = function (obj) {
		...
		with (obj) {
			...
			__p += ' ><div class="list-item"><div class="p"><a href="' + (null == (__t = url) ? "" : __t) + '" title=""><img  class="p-pic lazy" src="http://a.tbcdn.cn/mw/s/common/icons/nopic/no-90.png" dataimg="' + (null == (__t = img2 + "_" + size + ".jpg") ? "" : __t) + '"/>',
			icon && icon.length > 0 && !apply && (__p += '<span class="flag ' + (null == (__t = icon[0]) ? "" : __t) + '"></span>'),
			__p += '</a></div><div class="d"><a href="' + (null == (__t = url) ? "" : __t) + '" title=""><h3 class="d-title">' + (null == (__t = name) ? "" : __t) + '</h3></a><p class="d-price"><em class="h">￥' + (null == (__t = price || originalPrice) ? "" : __t) + "</em><del>",
			originalPrice != price && (__p += "￥" + (null == (__t = originalPrice) ? "" : __t)),
			__p += '</del></p><div class="d-main">',
			"" == freight || apply || (__p += '<p class="d-freight">' + (null == (__t = Number(freight) > 0 ? "运费" + freight : "免运费") ? "" : __t) + "</p>"),
			__p += '<p class="d-num">' + (null == (__t = act) ? "" : __t) + '人付款</p><p class="d-area">' + (null == (__t = area) ? "" : __t) + '</p></div></div></div><div class="icons-group">';
			for (var i = 0; i < iconlist.length; i++)
				__p += '<div class="' + (null == (__t = iconlist[i].className) ? "" : __t) + '">', iconlist[i].icon && (__p += '<div class="item-icon icons-' + (null == (__t = iconlist[i].icon) ? "" : __t) + '"></div>'), __p += (null == (__t = iconlist[i].text) ? "" : __t) + "</div>";
			__p += "</div></li>"
		}
		return __p
	},
	...
	templates["tpl-relkey"] = function (obj) {
		...
		with (obj) {
			...
			for (var i = 0, len = list.length; len > i; i++) {
				var item = list[i];
				__p += '<li data="' + (null == (__t = item.url) ? "" : __t) + '">' + (null == (__t = item.name) ? "" : __t) + "</li>"
			}
			__p += "</ul></div>"
		}
		return __p
	...
	templates["tpl-sift"] = function (obj) {
		...
		with (obj)__p += '<div class="sift-mask" id="J_SiftMask" style="display:none"></div><div class="sift-content" id="J_SiftContent" style="display:none;"><form action=""><div class="sift-top">共<span class="sift-result">1220</span>条结果<button class="sift-btn-ok">确定</button><span class="sift-clear" id="J_SiftClear">清空条件</span></div><div class="sift-box"><div class="sift-default sift-hide sift-row3 J_SiftConditionBox J_MultiSelect"><h3>商家类型</h3><div class="sift-condition"><ul class="clearfix"><li><i class="icons-sift-select"></i>天猫</li><li><i class="icons-sift-select"></i>全球购</li><li><i class="icons-sift-select"></i>二手</li><li><i class="icons-sift-select"></i>7天退换</li><li><i class="icons-sift-select"></i>货到付款</li><li><i class="icons-sift-select"></i>手机专享</li><li><i class="icons-sift-select"></i>送货上门测试测试</li><li><i class="icons-sift-select"></i>包邮</li><li><i class="icons-sift-select"></i>会员vip</li></ul></div><div class="icons-sift-down"><div class="icons-sift-up"></div></div></div></div><div class="sift-box"><div class="sift-default sift-place sift-hide J_SiftConditionBox"><h3>所在地</h3><div class="sift-condition"><h4>常用</h4><ul class="clearfix"><li><i class="icons-sift-select"></i>所有地区</li><li><i class="icons-sift-select"></i>广州</li><li><i class="icons-sift-select"></i>海外</li><li><i class="icons-sift-select"></i>江浙沪</li><li><i class="icons-sift-select"></i>上海</li><li><i class="icons-sift-select"></i>杭州</li><li><i class="icons-sift-select"></i>珠三角</li><li><i class="icons-sift-select"></i>北京</li><li><i class="icons-sift-select"></i>港澳台</li></ul><h4>城市</h4><ul class="clearfix"><li><span class="initial">C</span><i class="icons-sift-select"></i>长沙</li><li><i class="icons-sift-select"></i>长春</li><li><i class="icons-sift-select"></i>成都</li><li><span class="initial">D</span><i class="icons-sift-select"></i>大连</li><li><i class="icons-sift-select"></i>东莞</li><li></li><li><span class="initial">H</span><i class="icons-sift-select"></i>杭州</li><li><i class="icons-sift-select"></i>合肥</li><li><i class="icons-sift-select"></i>哈尔滨</li><li><span class="initial">J</span><i class="icons-sift-select"></i>济南</li><li></li><li></li><li><span class="initial">K</span><i class="icons-sift-select"></i>昆明</li><li></li><li></li><li><span class="initial">N</span><i class="icons-sift-select"></i>宁波</li><li><i class="icons-sift-select"></i>南京</li><li><i class="icons-sift-select"></i>南昌</li><li><span class="initial">Q</span><i class="icons-sift-select"></i>青岛</li><li></li><li></li><li><span class="initial">S</span><i class="icons-sift-select"></i>苏州</li><li><i class="icons-sift-select"></i>石家庄</li><li><i class="icons-sift-select"></i>沈阳</li><li><span class="initial">T</span><i class="icons-sift-select"></i></li><li></li><li></li><li><span class="initial">W</span><i class="icons-sift-select"></i>温州</li><li><i class="icons-sift-select"></i>无锡</li><li><i class="icons-sift-select"></i>武汉</li><li><span class="initial">X</span><i class="icons-sift-select"></i>西安</li><li><i class="icons-sift-select"></i>厦门</li><li></li><li><span class="initial">Z</span><i class="icons-sift-select"></i>郑州</li><li></li><li></li></ul><h4>省份</h4><ul class="clearfix"><li><span class="initial">A</span><i class="icons-sift-select"></i>安徽</li><li><i class="icons-sift-select"></i>澳门</li><li></li><li><span class="initial">F</span><i class="icons-sift-select"></i>福建</li><li></li><li></li><li><span class="initial">G</span><i class="icons-sift-select"></i>甘肃</li><li><i class="icons-sift-select"></i>广东</li><li><i class="icons-sift-select"></i>广西</li><li><i class="icons-sift-select"></i>贵州</li><li></li><li></li><li><span class="initial">H</span><i class="icons-sift-select"></i>海南</li><li><i class="icons-sift-select"></i>河北</li><li><i class="icons-sift-select"></i>河南</li><li><i class="icons-sift-select"></i>湖北</li><li><i class="icons-sift-select"></i>湖南</li><li><i class="icons-sift-select"></i></li><li><span class="initial">J</span><i class="icons-sift-select"></i>江苏</li><li><i class="icons-sift-select"></i>吉林</li><li></li><li><span class="initial">L</span><i class="icons-sift-select"></i>辽宁</li><li></li><li></li><li><span class="initial">N</span><i class="icons-sift-select"></i>内蒙古</li><li><i class="icons-sift-select"></i>宁夏</li><li></li><li><span class="initial">Q</span><i class="icons-sift-select"></i>青海</li><li></li><li></li><li><span class="initial">S</span><i class="icons-sift-select"></i>山东</li><li><i class="icons-sift-select"></i>山西</li><li><i class="icons-sift-select"></i>陕西</li><li><i class="icons-sift-select"></i>四川</li><li></li><li></li><li><span class="initial">T</span><i class="icons-sift-select"></i>台湾</li><li></li><li></li><li><span class="initial">X</span><i class="icons-sift-select"></i>西藏</li><li><i class="icons-sift-select"></i>新疆</li><li><i class="icons-sift-select"></i>香港</li><li><span class="initial">Y</span><i class="icons-sift-select"></i>云南</li><li></li><li></li><li><span class="initial">Z</span><i class="icons-sift-select"></i>浙江</li><li></li><li></li></ul></div><div class="icons-sift-down"><div class="icons-sift-up"></div></div></div></div><div class="sift-box"><div class="sift-default sift-hide sift-row3 J_SiftConditionBox"><h3>类目分类</h3><div class="sift-condition"><ul class="clearfix"><li><i class="icons-sift-select"></i>女装</li><li><i class="icons-sift-select"></i>男装</li><li><i class="icons-sift-select"></i>老年装</li><li><i class="icons-sift-select"></i>童装</li><li><i class="icons-sift-select"></i>连衣裙</li><li><i class="icons-sift-select"></i>手机专享</li><li><i class="icons-sift-select"></i>衬衫</li><li><i class="icons-sift-select"></i>蕾丝衫雪纺衫</li><li></li></ul></div><div class="icons-sift-down"><div class="icons-sift-up"></div></div></div></div><div class="sift-box sift-combo"><div class="sift-default sift-hide sift-row4 J_SiftConditionBox"><h3>品牌</h3><div class="sift-condition"><ul class="clearfix"><li><i class="icons-sift-select"></i>韩都衣舍</li><li><i class="icons-sift-select"></i>七格格</li><li><i class="icons-sift-select"></i>ZARA</li><li><i class="icons-sift-select"></i>耐克</li><li><i class="icons-sift-select"></i>连衣裙</li><li><i class="icons-sift-select"></i>七匹狼</li><li><i class="icons-sift-select"></i>茵曼</li><li><i class="icons-sift-select"></i>歌瑞尔</li><li><i class="icons-sift-select"></i>夜太深</li><li><i class="icons-sift-select"></i>小贝潮品</li><li><i class="icons-sift-select"></i>创意人士</li><li><i class="icons-sift-select"></i>cnss旗舰店</li></ul></div><div class="icons-sift-down"><div class="icons-sift-up"></div></div></div><div class="sift-default sift-hide sift-row3 J_SiftConditionBox"><h3>尺码</h3><div class="sift-condition"><ul class="clearfix"><li><i class="icons-sift-select"></i>XXS</li><li><i class="icons-sift-select"></i>XS</li><li><i class="icons-sift-select"></i>S</li><li><i class="icons-sift-select"></i>M</li><li><i class="icons-sift-select"></i>L</li><li><i class="icons-sift-select"></i>XL</li><li><i class="icons-sift-select"></i>XXL</li><li><i class="icons-sift-select"></i>XXXL</li><li><i class="icons-sift-select"></i>均码</li></ul></div><div class="icons-sift-down"><div class="icons-sift-up"></div></div></div><div class="sift-default sift-hide sift-row3 J_SiftConditionBox"><h3>价格</h3><div class="sift-condition"><ul class="price-list clearfix"><li><i class="icons-sift-select"></i><span class="price-per">最多人喜欢</span><span class="price-area price-ar1" style="width:45%">&nbsp;0~150</span></li><li><i class="icons-sift-select"></i><span class="price-per">29%的用户选择</span><span class="price-area price-ar2" style="width:29%">&nbsp;150~250</span></li><li><i class="icons-sift-select"></i><span class="price-per">20%的用户选择</span><span class="price-area price-ar3" style="width:20%">&nbsp;250~500</span></li></ul></div><div class="icons-sift-down"><div class="icons-sift-up"></div></div></div><div class="sift-default sift-hide sift-row2 J_SiftConditionBox"><h3>风格</h3><div class="sift-condition"><ul class="clearfix"><li><i class="icons-sift-select"></i>时尚</li><li><i class="icons-sift-select"></i>学院风</li><li><i class="icons-sift-select"></i>简约</li><li><i class="icons-sift-select"></i>耐克</li><li><i class="icons-sift-select"></i>连衣裙</li><li><i class="icons-sift-select"></i>七匹狼</li></ul></div><div class="icons-sift-down"><div class="icons-sift-up"></div></div></div></div></form></div>';
		return __p
	},
	"function" == typeof define && "object" == typeof define.amd && define.amd ? define(["lodash"], function (a) {
		_ = a,
		a.templates = a.extend(a.templates || {}, templates)
	}) : freeExports && freeModule ? (_ = require("lodash"), moduleExports ? (freeModule.exports = templates).templates = templates : freeExports.templates = templates) : _ && (_.templates = _.extend(_.templates || {}, templates))
}
.call(this), define("searchH5/pages/searchlist/_.index", ["./deps/components/data-manager/index", "./deps/components/lazyload/index", "./deps/components/util/index", "./mods/listview/index", "./mods/old_sift/index", "./mods/old_sift/lefttab", "./mods/old_sift/selNavTemp", "./mods/searchbox/index", "./js/main", "./js/onesearch"], function (a) {
	var b = window.deps = {
		components : {},
		mods : {}

	};
	b.components["data-manager"] = a("./deps/components/data-manager/index"),
	b.components.lazyload = a("./deps/components/lazyload/index"),
	b.components.util = a("./deps/components/util/index"),
	b.mods.listview = a("./mods/listview/index"),
	b.mods.old_sift = a("./mods/old_sift/index"),
	b.mods.searchbox = a("./mods/searchbox/index"),
	a("./js/main")
}), define("searchH5/pages/searchlist/deps/components/data-manager/index", [], function () {
	function a(a) {
		this.params = a.data,
		this.url = a.url;
		var b = {
	...
	a.prototype = {
		...
		getData : function (b) {
			...
			b.success = function (a, b, e) {
				...
				f.forEach(function (b) {
					var d = b;
					if ("/" == d.indexOf(0) && (d = d.slice(1)), "/" == b)
						return void c.trigger(b, a);
					var e = d.split("/"),
					f = a;
			...
			$.ajax($.extend(_.clone(this.opt), b))
		},
		onData : function (a, b) {
		...
		offData : function (a, b) {
			for (var c = 0; c < this.dataListenerList.length; c++)
				this.dataListenerList[c] === a && this.dataListenerList.splice(c, 1);
			this.off(a, b)
		}
	},
	Emitter(a.prototype),
	...
	if (void 0 == window.define) {
		...
		define("searchH5/pages/searchlist/deps/components/lazyload/index", [], a)
}
(function (a, b, c) {
	function d(a, b) {
	...
	function e(a, b) {
		if (a) {
			...
			h;
			if (a != f)
				h = a.offset ? a : $(a), h = h.offset(), c = h.width, d = h.height, e = h.left, g = h.top;
			else {
				var i = b && b.y || 0,
				j = b && b.x || 0;
				c = a.innerWidth + j,
...
}), define("searchH5/pages/searchlist/deps/components/util/index", [], function () {
	function a(a) {
		a || (a = location.href);
		var b,
		c,
		...
		if (e) {
			...
			for (var f = 0; f < c.length; f++)
				b = c[f].split("="), d[b[0]] = decodeURIComponent(b[1])
		}
		return d
	}
	...
	DEFAULT_IMG_URL = "http://a.tbcdn.cn/mw/s/common/icons/nopic/no-90.png",
	...
	return ListView.prototype = {
		...
		events : function () {
			...
			this.listContainer.on("click", ".type-tip li", function (a) {
		...
		query : function (a) {
			...
			b.pageDataMap = {},
			c.show(),
			this.gotopage(1, function (a) {
				b.__oldInterfaceAdapter(a),
				b._calculate(),
				c.hide(),
				a.listItem.length <= 0 ? b.listContainer.html("没有搜索到相关宝贝") : this.currentPageIndex = 1
			})
		},
		...
		renderListItem : function (a, b) {
			...
			_.extend(a, {
				...
				price : c(a.price),
				originalPrice : c(a.originalPrice),
				act : d(a.act, 1e4, "万")
			}),
		...
		changeViewType : function (a) {
			function b(a, b) {
				for (var c, d, e = 0, f = a.length; f > e; e++)
					d = a.eq(e), d.hasClass("lazy") ? c = d.attr("dataimg") : (d.addClass("lazy"), c = d.attr("src"), d.attr("src", DEFAULT_IMG_URL)), c = c.replace(/_\d+x\d+\.jpg?/g, "_" + b + ".jpg"), d.attr("dataimg", c)
			}
			var c = $("#J_SearchList"),
		...
		fetchData : function (pageindex, callback) {
			...
			return self.fetching ? void(callback && callback({})) : (self.fetching = !0, void this.dataManager.getData({
					...
					success : function (json) {
						"string" == typeof json && (json = json.replace(/\\/g, "\\\\"), json = JSON ? JSON.parse(json) : eval("(" + json + ")")),
		...
		resumePageItem : function (a) {
			for (var b, c = this, d = a.filter(".recycle"), e = d.length - 1; e >= 0; e--)
				b = d.eq(e), c.getPageDom(b.attr("data-page"), function (a) {
			...
			if (!($(".J_PageContainer_" + a).length > 0)) {
				...
				this.getPageDom(a, function (e) {
					...
					if (d || (c.initWithData(), d = c.listContainer), !e || !e.success) {
						if (c.toploading.hide(), c.bottomloading.hide(), c.defaultLoading.hide(), !e)
							return;
		...
		__oldInterfaceAdapter : function (a, b) {
			function c(a) {
				f.opage && f.opage.$container.empty(),
				f.opage = new PageNav({
						container : "#J_PageNavContainer",
						pageCount : a.totalPage
					}),
				f.opage.$container.on("page:change", function (a, b) {
					f.gotopage(b.index)
				})
			}
			function d(a) {
				$('<iframe class="onesearch-iframe"></iframe>', {
					src : a.url,
					height : "0px",
					width : "100%",
					"data-height" : a.height,
					scrolling : "no"
				}).appendTo($(".onesearch-container"))
			}
			function e(a) {
			...
			var f = this;
			(!f.noFirst || b) && c(a),
			f.noFirst || (a.selecthot && e(a.selecthot), a.oneSearch && d(a.oneSearch), f.noFirst = !0)
		}
	},
	PageNav.prototype = {
		init : function () {
	...
	ListView
}), define("searchH5/pages/searchlist/mods/old_sift/index", ["searchH5/pages/searchlist/mods/old_sift/lefttab", "searchH5/pages/searchlist/mods/old_sift/selNavTemp"], function (a) {
	var b = swipetop = a("searchH5/pages/searchlist/mods/old_sift/lefttab"),
	c = a("searchH5/pages/searchlist/mods/old_sift/selNavTemp"),
	d = 40,
	e = 8,
	f = {
		oDiv : $("#J_select"),
		...
		init : function () {
			...
			var d = $("#J_sortCont"),
			e = $("#J_areaCont");
			$("#J_selt").on("tap", function () { {
					var a = $(this);
					a.index()
				}
				$("#swipeCont-1").show().siblings().hide(),
				b.showLeft()
			}),
			$("#J_sift").on("tap", function () {
				$(this);
				$("#swipeCont-2").show().siblings().hide(),
				b.showLeft()
			}),
			$("#J_siftTab li").on("tap", function () {
				var a = $(this),
				b = a.index();
				a.addClass("cur").siblings().removeClass("cur"),
				0 == b ? (d.show(), e.hide()) : 1 == b && (e.show(), d.hide())
			}),
			$("#tbh5v0").on("click", ".leftmask", function () {
				var a = $(this);
				a.remove(),
				b.hideLeft()
			});
			var f = window.globle.dataManagers.list;
			f.onData("nav", function g(a) {
				c.typeInt(a),
				f.offData("nav", g)
			}),
			a.events()
		...
		events : function () {
			var a = this;
			a.oDiv.on("click", "h2", function () {
				var b = $(this);
				a.h2Type(b),
				window.scroll(0, 0)
			}).on("click", ".property", function () {
				var b = $(this),
				c = b.attr("dataUrl");
				a.getList(c, b, !1),
				swipetop.hideLeft(),
				...
				var a = $(this),
				b = a.next();
				a.hasClass("off") ? (b.slideDown(), a.parent().siblings().children("div").slideUp(), a.parent().siblings().children("h5").removeClass("on").addClass("off"), a.removeClass("off").addClass("on")) : (b.slideUp(), a.removeClass("on").addClass("off")),
				swipetop.refresh(),
				window.scroll(0, a.offset().top)
			}).on("click", ".J_more", function () {
				var b = $(this);
				a.more(b),
				swipetop.refresh()
			}).on("click", ".J_refresh", function () {
				var b = $(this),
				c = b.parents("li").find("h2").attr("dataUrl"),
				d = b.parents(".J_load").eq(0),
				e = b.parents("li").find("h2");
				d.html('<p class="loading"><span></span></p>'),
				a.getList(c, e)
			})
		},
		h2Type : function (a) {
			function b() {
				a.removeClass("hide").addClass("on"),
				a.parent().parent().height("auto"),
				a.parent().siblings().slideUp(),
				a.siblings().slideDown(),
				a.next(".J_type").html(""),
				a.after('<div class="c-loading loader-dark J_load"><p class="loading"><span></span></p></div>');
				var b = a.attr("dataUrl");
				h.getList(b, a, !0)
			}
			function f() {
				a.parent().siblings(".J_more").length > 0 && a.parent().parent().height(e * d),
				a.removeClass("on").addClass("hide"),
				a.parent().find("ul li").show();
				var b = a.siblings().find("h2"),
				c = b.hasClass("on");
				c && b.removeClass("on").addClass("hide") || b.removeClass("on"),
				a.siblings().slideUp(),
				a.parent().siblings().slideDown()
			}
			function g() {
				a.siblings().find("li").first().hasClass("J_more") && a.siblings().height(e * d),
				a.parent().parent().height("auto"),
				a.removeClass("hide").addClass("on"),
				a.siblings().find("ul").hide(),
				a.siblings().slideDown(),
				a.parent().siblings().slideUp()
			} {
				var h = this;
			...
			if (a.hasClass("request") && a.hasClass("hide")) {
				var i = (a.attr("pagedata"), a.attr("pageurldata")),
				j = a.next().find("li").eq(0);
				h.oPageUrl.val(i),
				swipetop.hideLeft(),
				g(),
				c.highlight(j),
				...
				a.hasClass("hide") ? g() : a.hasClass("on") ? f() : b();
			swipetop.refresh()
		},
		more : function (a) {
			a.parent().css({
				"-webkit-transition" : "height 0.3s ease-in-out",
				height : a.siblings().length * d
			}),
			a.remove()
		},
		getList : function (a, b, d) {
			ajaxurl = a,
			$.ajax({
				url : ajaxurl,
				type : "GET",
				...
				data : "page=1",
				error : function () {
					b.siblings(".J_load").html('网络链接失败，点击 <em class="c-btn-grey-small J_refresh">刷新</em> 重试')
				},
				success : function (a) {
					c.typeInt(a, b, d)
				}
	...
	return $.fn.wrap = function (a) {
		if (this[0])
			var b = $(a).get(0);
		return this.each(function () {
			$(this).before(b = $(b));
			for (var a; (a = b.children()).length; )
				b = a.first();
			$(b).append(this)
		})
	},
	...
	f
}), define("searchH5/pages/searchlist/mods/old_sift/lefttab", [], function () {
	var a = {
		contShow : $("#swipeTop"),
		...
		init : function () {
			var a = this;
			a.contShow.find(".tab-2 li").each(function (b, c) {
				$(c).click(function () {
		...
		showLeft : function () {
			...
			a.bodyCont.css({
				"min-height" : a.swipeTabCont.height() + 70
			}),
			a.leftCate.css({
				height : a.bodyCont.height()
			}),
			$("#tbh5v0").append('<div class="leftmask"></div>'),
			a.translation(a.contShow[0], {
				x : 0
			}, function () {
				$(".leftmask").height(a.leftCate.height())
			})
		},
		hideLeft : function () {
			var a = this;
			a.category.removeClass("on").addClass("hide"),
			a.translation(a.leftCate[0], {
				x : 280,
				duration : "0.4s"
			}, function () {
				$(".leftmask").remove(),
		...
		refresh : function () {
			...
			b = setTimeout(function () {
					var b = a.swipeTabCont.height() + 70;
					a.bodyCont.css({
						"min-height" : b
					}),
					a.leftCate.css({
	...
	return a
}), define("searchH5/pages/searchlist/mods/old_sift/selNavTemp", ["searchH5/pages/searchlist/mods/old_sift/lefttab"], function (a) {
	var b = a("searchH5/pages/searchlist/mods/old_sift/lefttab"),
	c = {
		oPageUrl : $("#J_Page_Url"),
		oDiv : $("#J_select"),
		typeInt : function (a, c, d) {
			function e() {
				for (var b, d, e, g, h, i, j = [], k = 0, l = 0, o = a.navPropList.length; o > l; l++) {
					for (var p = a.navPropList[l].propName, q = a.navPropList[l].propList, r = "", s = "", t = [], u = "", v = "", w = 0, x = q.length; x > w; w++) { {
							var y = new Date,
							z = y.getTime(),
							A = q[w].url,
							B = q[w].name,
							...
							D = q[w].catmap,
							E = q[w].ppath,
							F = q[w].catmap + q[w].ppath + z;
							q[w].id
						}
						2 >= w ? r += 3 == q.length && 2 == w || 2 == q.length && 1 == w || 1 == q.length && 0 == w ? B : B + " | " : 3 == w && (r += B),
						e = "property",
						g = A,
						i = F,
						1 == C && (i = F + "1", u = !0, H = !0, v = "h", s = B, k++, e = "property highlight"),
						t.push('<p class="' + e + '"'),
						t.push(' dataurl="' + A + '"'),
						t.push('catmap="' + D + '" ppath="' + E + '"'),
						t.push(">"),
						t.push(B),
						t.push("</p>")
					}
					...
					b = "off sub",
					d = "display:none",
					j.push('<li dataid="' + i + '"><h5 class="' + b + " " + v + '">'),
					j.push(p + '<span class="' + v + '">' + G + "</span></h5><div "),
					j.push('style=" height:' + Math.min(w, m) * n + "px;overflow:hidden;position:relative;" + d + '"	'),
					j.push(">" + t.join("")),
					w > m && j.push('<p class="J_more"">更多 ...</p>'),
					j.push("</div></li>")
				}
				return c && f.highlight(c),
				j.join("")
			}
			var f = this,
			g = a.allTitle,
			...
			if ("1" == a.navType)
				if (a.isFlush) {
					...
					o = setTimeout(function () {
							...
							c.removeClass("on").addClass("hide")
						}, 400),
					k.attr({
						catmap : i,
						ppath : ""
					...
					var r = a.catmap,
					s = [];
					c && s.push('<li><h2 dataurl="' + h + '" catmap="' + r + '">' + g + "</h2></li>");
					for (var t = 0; t < a.navCatList.length; t++) {
						var u = a.navCatList[t].url,
						v = a.navCatList[t].name,
						w = a.navCatList[t].catmapId,
						x = a.navCatList[t].catmap,
						y = a.navCatList[t].navSubList,
						z = [],
						A = !1;
						if (y)
							for (var B = 0, C = a.navCatList[t].navSubList.length; C > B; B++) { {
									var D = a.navCatList[t].navSubList[B].subName,
									E = a.navCatList[t].navSubList[B].subUrl,
									w = a.navCatList[t].navSubList[B].catmap;
									a.navCatList[t].navSubList[B].id
								}
								A = !0,
								z.push("<li "),
								z.push('><h2 dataUrl="'),
						...
						A ? (close = "on", u = "") : close = "off",
						s.push('<li><h2 class="'),
						s.push(-1 == x ? "hide" : close),
						s.push('" dataUrl="'),
						s.push(u),
						s.push('" catmap="'),
						s.push(x),
						...
						s.push(v),
						s.push("</h2>"),
						A && (s.push('<ul class="subNav" '), -1 == x && s.push('style="display:none"'), s.push(">" + z.join("") + "</ul>")),
						s.push("</li>")
					}
					t > m && s.push('<li class="J_more"">更多 ...</li>'),
					c ? (c.after('<ul class="subNav" style="height:' + Math.min(t + 1, m) * n + 'px">' + s.join("") + "</ul>"), c.attr("dataurl", "")) : l.html('<ul class="subNav" style="height:' + Math.min(t + 1, m) * n + 'px">' + s.join("") + "</ul>")
				}
			else if ("2" == a.navType) {
				var F,
				r = a.catmap,
				...
				H = !1;
				F = 1 == G && "highlight" || "",
				c ? d ? (c.parent().find(".J_type").length <= 0 && c.after('<ul class="J_type"></ul>'), c.parent().find(".J_type").eq(0).html('<li><p class="property" dataurl="' + h + '" catmap="' + r + '">' + g + "</p></li>" + e())) : (H = !0, c.parents(".J_type").eq(0).html('<li><p class="property ' + F + '" dataurl="' + h + '" catmap="' + r + '">' + g + "</p></li>" + e())) : l.html(e()),
				H && c && (b.hideLeft(), f.oPageUrl.val(p), f.sortSearch(), c.attr("pageData", q), c.attr("pageUrlData", p), k.attr({
						catmap : i,
						ppath : j
					}))
			}
			c && c.siblings(".J_load").remove(),
			c && c.addClass("on"),
			c && b.refresh()
		},
		highlight : function (a) {
			var b,
			c = $(".highlight");
			b = a.hasClass("property") ? c[0] == a.parents("ul").eq(0).find(".highlight")[0] : c[0] == a.parents("li").eq(0).find(".highlight")[0],
			c.eq(0).hasClass("property") && !b && c.parents(".J_type").eq(0).siblings("h2").removeClass("hide"),
			c.removeClass("hide").removeClass("highlight")
		},
		sortSearch : function () {
			this.oDiv.triggerHandler("selNavTemp:sortSearch")
		}
	};
	return c
}), define("searchH5/pages/searchlist/mods/searchbox/index", [], function () {
	function a() {
		this.defaultParams = {
			nick : Util.getNickFromCookie(),
	...
	return Util = {
		...
		getNickFromCookie : function () {
			var a = this.getCookie("_w_tb_nick");
	...
	a.prototype = {
		...
		_findNodes : function () {
			...
			this.$from = this.$topBar.find("#J_Search"),
			this.$clearQueryBtn = $(".s-form-search button")
		},
		_eventAttach : function () {
			var a = this;
			this.$searchInput.on("click", function () {}).on("focus", function () {
			...
			this.$suggestContainer.on("tap", ".J_AddToQuery", function (b) {
				...
				if (!a._submiting && "DIV" !== b.target.tagName) {
					var d = a.$from.find(".sugg");
					0 == d.length && (d = $('<input name="sugg" class="sugg" type="hidden">').appendTo(a.$from)),
					d.val(a.$searchInput.val() + "_" + c.index() + "_" + c.parent("ul").attr("data-sugg-type")),
					a.$searchInput.val(c.text()),
					a._submiting = !0,
					a.$from.submit()
				}
			...
			this.$clearQueryBtn.on("tap", function () {
				a.$searchInput.val(""),
		...
		_inputChangeEvent : function () {
			var a = this.$searchInput.val().replace(/(^\s+)|(\s+$)/g, ""),
			b = this;
			"" != a ? this.$clearQueryBtn.show() : this.$clearQueryBtn.hide(),
			this._getSuggestItems(a, function (a) {
				b.$suggestContainer.html(a)
			})
		},
		_tabInit : function () {
			var a = $(".s-input-tab-txt"),
			b = $(".s-input-tab-nav");
			a.click(function () {
				b.hasClass("on") ? b.removeClass("on").addClass("off") : b.removeClass("off").addClass("on")
			}),
			b.find("li").click(function () {
				var b = $(this),
				c = b.attr("class");
				if (a.text(b.text()), b.hasClass("shop")) {
					var d = $(".J_autocomplete").val();
					location.href = "http://shop.m.taobao.com/shop/shop_search.htm?topSearch=1&q=" + d
				} else
					"tmall" == c && (c = "mall"), $("#J_SearchTab").val(c), $("#J_Search").submit()
			})
		},
		...
		_getSug : function (a, b) {
			...
			$.ajax({
				type : "get",
				url : "http://suggest.m.taobao.com/rpc/sug.json",
				data : $.extend({
					q : a
				}, this.defaultParams),
				dataType : "jsonp",
		...
		_cleanHistory : function () {
			$.ajax({
				type : "get",
				url : "http://suggest.m.taobao.com/rpc/history/clean.json?nick=" + this.defaultParams.nick,
				data : {
		...
		_getHistory : function (a) {
			...
			$.ajax({
				type : "get",
				url : "http://suggest.m.taobao.com/rpc/history/get.json?nick=" + this.defaultParams.nick,
				data : {
					sid : this.defaultParams.sid
				},
				dataType : "jsonp",
		...
		_getHotkey : function (a) {
			...
			$.ajax({
				type : "get",
				url : "http://suggest.m.taobao.com/rpc/hot_key.json?nick=" + this.defaultParams.nick,
				data : {
					sid : this.defaultParams.sid
				},
				dataType : "jsonp",
		...
		_renderHistory : function (a) {
			...
			for (var c = a.length > 10 ? 10 : a.length, d = 0; c > d; d++)
				b.push("<li>" + a[d].key + '<div class="add J_AddToQuery"><div class="icons-suggest-addto"></div></div></li>');
			return b.push("</ul>"),
	...
	a
}), define("searchH5/pages/searchlist/js/main", ["searchH5/pages/searchlist/js/onesearch"], function (a) {
	function b() {
		c(),
		m.onData("/", function a(b) {
			d(b.defaultViewType),
			m.offData("/", a)
		})
	}
	function c() {
		var a = m.params.bagvalue;
		a && $(".top-bar-w").prepend(_.templates["tpl-page-baghead"]({
				bagshow : a.split(",")[0]
			}))
	}
	function d(a) {
		function b() {
			...
			f = d.attr("data-value"),
			g = d.attr("data-order");
			if (d.hasClass("selected") && g)
				a();
			else {
				c = $(".J_sortTab .selected"),
				c.removeClass("selected up");
				var h = c.attr("data-default");
				h && c.attr("data-order", h),
				d.addClass("selected"),
				g ? a() : b = f
			}
		...
		var e = $(".filterbar-container"),
		f = _.templates["tpl-filterbar"]({
				viewtype : localStorage && localStorage.getItem("viewtype") || a || "list"
			});
		e.html(f),
		e.on("click", ".J_SwitchViewtype", c).on("click", function (a) {
			a.preventDefault(),
			a.stopPropagation()
		}),
		e.on("click", ".J_sortTab li", b)
	}
	function e() {
		f()
	}
	...
	window.SearchH5 = {
		dataConfig : {
			...
			listApi : {
				url : i.split("?")[0],
				params : h.getUrlParams(i)
			}
		}
	},
	window.globle = {};
	var j = window.SearchH5.dataConfig,
	k = j.listApi,
	l = deps.components["data-manager"],
	m = new l({
			url : k.url,
			data : k.params
		});
	...
	deps.mods.old_sift.init(),
	new deps.mods.searchbox;
	var n = new deps.mods.listview(".search-content"),
	o = {
		init : function () { {
				var a = this;
				location.href
			}
			window && window.SmartbannerJSON && lib && lib.smartbanner && (SmartbannerJSON.mainSearch.href = location.href.replace("http://", ""), lib.smartbanner.sbLogic(SmartbannerJSON.mainSearch, 2)),
			n.query(),
			a.events(),
			g(),
			b(),
		...
		events : function () { {
				var a = $("#J_Header"),
				b = (a.find(".closed"), $("#J_Search"), $("footer"), $("#ksearch"), $("#J_catmp"));
				$(".searchlist"),
				$(".filterbar-container")
			}
			window.globle.dataManagers.list.setParam(h.getUrlParams($("#J_Page_Url").val())),
			$("#J_select").on("selNavTemp:sortSearch", function () {
				var a = h.getUrlParams($("#J_Page_Url").val());
				a.ppath || m.removeParam("ppath"),
				n.query(a)
			}),
			$(".rellkey-container").on("tap", "li", function (a) {
				a.preventDefault();
				var b = $(this),
				c = b.attr("data");
				location.href = c
			}),
			$("#J_areaCont").find("li").on("tap", function () {
				var a = $(this),
				c = a.attr("dataurl"),
				d = b.attr("catmap"),
				e = b.attr("ppath"),
				f = ($("#J_catmp"), c.match(/catmap=.*/g)),
				g = f && f[0].split("&")[0];
				regPpath = c.match(/ppath=.*/g),
				repPpath = regPpath && regPpath[0].split("&")[0],
				c = f ? c.replace(g, "catmap=" + d) : c + "&catmap=" + d,
				c = regPpath ? c.replace(repPpath, "ppath=" + e) : c + "&ppath=" + e,
				location.href = c
			})
		}
	};
	return o.init()
}), define("searchH5/pages/searchlist/js/onesearch", [], function () {
	window.addEventListener("message", function (b) {
		console.log(b);
		var c = b.data,
		d = a[c.command](c.params);
